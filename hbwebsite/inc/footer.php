<div class="container-fluid bg-white mt-5">
  <div class="row">
    <div class="col-lg-4 p-4">
      <h3 class=" fw-bold fs-3 mb-2">Manipal Hotels</h3>
      <p>
      Experience unparalleled hospitality at Manipal Hotels, where comfort meets luxury. Discover tastefully appointed rooms, exceptional facilities, and personalized service.
      </p>
    </div>
    <div class="col-lg-4 p-4">
    ...
    <div class="col-lg-4 p-4">
        ...
        <a href="https://twitter.com/" class="d-inline-block text-dark text-decoration-none mb-2">
          <i class="bi bi-facebook me-1"></i> Twitter
        </a><br>
...
<h6 class="text-center bg-dark text-white p-3 m-0"> Developed by Himank , Madhav and Raiyan</h6>
