...
<head>
  ...
  <title>Manipal Hotels - PROFILE</title>
</head>
<body class="bg-light">
      ...
      <div class="col-12 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="info-form">
            ...
            <button type="submit" class="btn text-white btn-primary shadow-none">Save Changes</button>
          </form>
        </div>
      </div>
